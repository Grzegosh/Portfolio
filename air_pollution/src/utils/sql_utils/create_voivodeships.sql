CREATE TABLE IF NOT EXISTS air_pollution.cities(
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `woj_id` int(11) NOT NULL DEFAULT '0',
  `nazwa` varchar(250) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`));

INSERT INTO air_pollution.cities (`id`, `woj_id`, `nazwa`) VALUES
	(1, 2, 'Bolesławiec'),
	(2, 2, 'Nowogrodziec'),
	(3, 2, 'Bielawa'),
	(4, 2, 'Dzierżoniów'),
	...
	(919, 14, 'Warszawa'),
	(920, 30, 'Borówiec'),
	(921, 18, 'Rymanów Zdrój'),
	(922, 12, 'Zabierzów'),
	(923, 12, 'Szarów'),
	(924, 18, 'Nowiny'),
	(925, 24, 'Goczałkowice Zdrój'),
	(926, 8, 'Łagów');

CREATE TABLE IF NOT EXISTS air_pollution.voi (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nazwa` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
);

INSERT INTO air_pollution.voi (`id`, `nazwa`) VALUES
	(2, 'Dolnośląskie'),
...
CREATE TABLE IF NOT EXISTS air_pollution.cities_voivodeships (

    `city` VARCHAR(250),
    `voivodeship` VARCHAR(250)

);

INSERT INTO air_pollution.cities_voivodeships(`city`, `voivodeship`)

SELECT
	c.nazwa AS `city`,
    v.nazwa AS `voivodeship`

FROM
	air_pollution.cities c
LEFT JOIN
	air_pollution.voi v
ON
	c.woj_id = v.id
